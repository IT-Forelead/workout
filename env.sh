...
export MAILER_USERNAME="exru05@gmail.com"
export MAILER_PASSWORD="k7WW43znj6mPNNa"
...
export MONITORING_HOST="smtp.mail.ru"
export MONITORING_PORT=587
export MONITORING_USERNAME="monitoring@scala.uz"
export MONITORING_PASSWORD="SPyXhM7dmPD5803qdJC5"
export MONITORING_RECIPIENTS="[\"safabayev@mail.ru\"]"
