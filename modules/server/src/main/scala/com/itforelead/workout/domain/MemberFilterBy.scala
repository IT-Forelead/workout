...
object MemberFilterBy {
  ...
  val types: List[MemberFilterBy] =
    List(FirstnameAZ, FirstnameZA, LastnameAZ, LastnameZA, ActiveTime)
  ...
  implicit val encType: Encoder[MemberFilterBy] =
    Encoder.encodeString.contramap[MemberFilterBy](_.value)
